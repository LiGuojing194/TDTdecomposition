...
def undirected_truss(graph: CSRCOO, columns_g, edges_id_nbr, directed_ptr, n_cut_s, n_cut):
...
def main_csrcgraph(args):
    ...
    max_t = undirected_truss(graph, columns_g, edges_id_nbr, directed_ptr, n_cut_s, n_cut)
