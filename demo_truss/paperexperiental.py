...
from myisinmm import segment_isinmm
import logging 
...
truss_cuda_10_atomic1->2->multigpu_truss_pre2.py  改成不提取受影响子图，并用e_truss和truss_ptr来存储分解结果
...
def main_csrcgraph(args):
    ...
    # new_k_truss = torch.compile(k_truss, backend="inductor")
